...
/**
	...
	function widget( $args, $instance ) {
		...
		echo '<div style="position:relative;border:0px;padding:0;margin:0px;background-color:'.$color.';width:'.$width.'px;height:230px;line-height:1;">';
		...
		if ($meret>=1) {
			...
			echo '<span style="color:white;left:'.($margo1+27+$daych[0]).'px;top:40px;font-family:arial;font-size:25px;color:'.$daynumbercolor.';position:absolute;">'.$day[0].'</span>';
			echo '<span style="color:white;left:'.($margo1+33).'px;top:68px;font-family:arial;font-size:10px;color:'.$monthcolor.';position:absolute;">'.$month[0].'</span>';
		...
		if ($meret>=2) {
			...
			'<span style="color:white;left:'.($margo1*2+84+$daych[1]).'px;top:40px;font-family:arial;font-size:25px;color:'.$daynumbercolor.';position:absolute;">'.$day[1].'</span>'.
			'<span style="color:white;left:'.($margo1*2+90).'px;top:68px;font-family:arial;font-size:10px;color:'.$monthcolor.';position:absolute;">'.$month[1].'</span>'.
			...
			'<span style="color:white;left:'.($margo1*3+141+$daych[2]).'px;top:40px;font-family:arial;font-size:25px;color:'.$daynumbercolor.';position:absolute;">'.$day[2].'</span>'.
			'<span style="color:white;left:'.($margo1*3+147).'px;top:68px;font-family:arial;font-size:10px;color:'.$monthcolor.';position:absolute;">'.$month[2].'</span>'.
			...
			'<span style="color:white;left:'.($margo1*4+201+$daych[3]).'px;top:40px;font-family:arial;font-size:25px;color:'.$daynumbercolor.';position:absolute;">'.$day[3].'</span>'.
			'<span style="color:white;left:'.($margo1*4+207).'px;top:68px;font-family:arial;font-size:10px;color:'.$monthcolor.';position:absolute;">'.$month[3].'</span>'.
		...
		if ($meret>=5) {
			...
			'<span style="color:white;left:'.($margo1*5+255+$daych[4]).'px;top:40px;font-family:arial;font-size:25px;color:'.$daynumbercolor.';position:absolute;">'.$day[4].'</span>'.
			'<span style="color:white;left:'.($margo1*5+261).'px;top:68px;font-family:arial;font-size:10px;color:'.$monthcolor.';position:absolute;">'.$month[4].'</span>'.
			...
			echo '<a href="'.$link.'" title="esotanc" rel="nofollow" style="text-decoration:none;text-transform:none;color:'.$textcolorwp.';left:20px;top:212px;font-weight:400;font-family:arial;font-size:11px;position:absolute;" TARGET="_blank">ESOTANC.HU</a>';
